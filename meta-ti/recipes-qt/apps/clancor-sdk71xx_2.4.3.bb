...
FILES_${PN}-dbg = " \
	/opt/sdk71xx/bin/.debug/ClanCor_HHC  \
"
...
FILES_${PN} = " \
  ...
  /opt/sdk71xx \
  /opt/sdk71xx/bin \
  /opt/sdk71xx/resources \
  /opt/sdk71xx/bin/ClanCor_HHC \
...
do_install() {
	install -d ${D}/opt/
	install -d ${D}/opt/sdk71xx
	install -d ${D}/opt/sdk71xx/bin
	install -d ${D}/opt/sdk71xx/resources
	install -d ${D}/usr
	install -d ${D}/usr/lib
	install -m 0755 ${WORKDIR}/clancor-sdk_${PV}/bin/ClanCor_HHC  ${D}/opt/sdk71xx/bin/
	install -m 0755 ${WORKDIR}/clancor-sdk_${PV}/resources/sdk.sh ${D}/opt/sdk71xx/resources
